...
public class Reelcontoroller2 : MonoBehaviour
{
    //共通変数
    ...
    LotteryCreator2 Lottery = new LotteryCreator2();
    ...
    void Update()
    {
        ...
        if (SpinButtonFlg == true)
        {
            ...
            {
                transform.position = new Vector3(-6, 11.2f + ShiftPoint, 0);
            }
        }
    ...
    void PlaySlot()
    {
        ...
        //stopボタン
        if (Input.GetKey(KeyCode.JoystickButton3) || Input.GetKey(KeyCode.Q) && SpinButtonFlg == true)
        {
            StopButtonFlg = true;
        }
