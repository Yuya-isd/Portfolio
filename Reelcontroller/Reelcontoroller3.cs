...
public class Reelcontoroller3 : MonoBehaviour
{
    //共通変数
    ...
    LotteryCreator3 Lottery = new LotteryCreator3();
    ...
    {        
        ...
        //stopボタン
        if (Input.GetKey(KeyCode.JoystickButton1) || Input.GetKey(KeyCode.E) && SpinButtonFlg == true)
        {
            StopButtonFlg = true;
        }
    }
